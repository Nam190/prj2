...
namespace lvnk22cnt1prj2.Controllers
{
    public class SAN_PHAMController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,Ten_san_pham,Mo_ta,Gia,So_luong_ton_kho,CategoryID")] SAN_PHAM sAN_PHAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,Ten_san_pham,Mo_ta,Gia,So_luong_ton_kho,CategoryID")] SAN_PHAM sAN_PHAM)
        {
            if (ModelState.IsValid)
            {
